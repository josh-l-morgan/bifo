...
def scan_zarr_to_fig(zarr_group, pw=None, cw=[1, 512, 512], scan_mips=[1], dsamp=[1, 2, 2]):
    """
    ...
    for a in range(num_mip):
        fig.ax[a].img = fig.ax[a].imshow(z_mean, cmap='gray', vmax=255)
